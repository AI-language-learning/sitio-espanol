...
{return IWCreatePhotocast("file://localhost/Volumes/PORTABLE160/Sites/Site/preguntas_sobre_las_clases_files/rss.xml",true);}
...
loadMozillaCSS('preguntas_sobre_las_clases_files/preguntas_sobre_las_clasesMoz.css')
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');NotificationCenter.addObserver(null,relayoutMediaGrid_id2,'RangeChanged','id2')
Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','0');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','1');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','2');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','3');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','4');IMpreload('preguntas_sobre_las_clases_files','shapeimage_1','5');initializeMediaStream_id2()
