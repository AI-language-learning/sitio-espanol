...
{return IWCreatePhotocast("file://localhost/Volumes/PORTABLE160/Sites/Site/me_gusta_files/rss.xml",false);}
...
IWLayoutPhotoGrid('id2',new IWPhotoGridLayout(2,new IWSize(258,258),new IWSize(258,0),new IWSize(309,272),27,27,0,new IWSize(0,0)),new IWEmptyStroke(),imageStream,range,new IWShadow({blurRadius:10,offset:new IWPoint(4.2426,4.2426),color:'#000000',opacity:0.750000}),null,1.000000,{backgroundColor:'rgb(255, 255, 255)',reflectionHeight:0,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
...
loadMozillaCSS('me_gusta_files/me_gustaMoz.css')
