...
{return IWCreatePhotocast("file://localhost/Volumes/PORTABLE160/Sites/Site/mac_input_files/rss.xml",true);}
...
loadMozillaCSS('mac_input_files/mac_inputMoz.css')
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');NotificationCenter.addObserver(null,relayoutMediaGrid_id2,'RangeChanged','id2')
Widget.onload();fixAllIEPNGs('Media/transparent.gif');IMpreload('mac_input_files','shapeimage_2','0');initializeMediaStream_id2()
